...
/* 7. 영화 */
insert into MOVIE(MOVIE_CODE, MOVIE_NAME, MOVIE_GENRE, RUNNING_TIME, MOVIE_GRADE, RELEASE_DATE, INTRO, MAIN_IMAGE, DAILY_AUDIENCE, TOTAL_AUDIENCE, MOVIE_DELETE, SHOWING)
values ('mc1','체인소맨','액션','120','15', '2025-10-20','체인카우맨','메인이미지경로','15000','3000000', 'F','상영중');

insert into MOVIE(MOVIE_CODE, MOVIE_NAME, MOVIE_GENRE, RUNNING_TIME, MOVIE_GRADE, RELEASE_DATE, INTRO, MAIN_IMAGE, DAILY_AUDIENCE, TOTAL_AUDIENCE, MOVIE_DELETE, SHOWING)
values ('mc2','위키드','판타지','135','ALL', '2025-10-15','위키드2','메인이미지경로','25000','7900000', 'F','상영중');

insert into MOVIE(MOVIE_CODE, MOVIE_NAME, MOVIE_GENRE, RUNNING_TIME, MOVIE_GRADE, RELEASE_DATE, INTRO, MAIN_IMAGE, DAILY_AUDIENCE, TOTAL_AUDIENCE, MOVIE_DELETE, SHOWING)
values ('mc3','나우유시미3','판타지','120','12', '2025-11-5','재미가..','메인이미지경로','150','250000', 'F','상영중');
...
/* 19. 트레일러 */
insert into TRAILER(TRAILER_CODE, URL_PATH) values ('tc1','url경로');
insert into TRAILER(TRAILER_CODE, URL_PATH) values ('tc2','url경로');
insert into TRAILER(TRAILER_CODE, URL_PATH) values ('tc3','url경로');

/* 20. 이미지 */
insert into MOVIE_IMAGE(POSTER_IMAGE, TRAILER_CODE, MOVIE_CODE) values ('pi1','tc1','mc1');
insert into MOVIE_IMAGE(POSTER_IMAGE, TRAILER_CODE, MOVIE_CODE) values ('pi2','tc2','mc2');
insert into MOVIE_IMAGE(POSTER_IMAGE, TRAILER_CODE, MOVIE_CODE) values ('pi3','tc3','mc3');
