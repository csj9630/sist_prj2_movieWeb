...
/* 		uDTO.setBirth(birthDate); */ 
		...
		<div class="error-wrapper">
            <p>입력하신 <strong>${ param.users_id }</strong>는 이미 사용중입니다.</p>
            <p>다른 아이디를 입력해주세요.</p>
		...
		<c:choose>
			<c:when test="${addFlag }">
				<div class="success-wrapper">
                    ...
                    <a href="${commonURL}/user/main/index.jsp" class="btn-main-page" style="color:black;">메인페이지로 이동</a>
                </div>
                
			</c:when>
			<c:otherwise>
				<div class="error-wrapper">
                    <p>죄송합니다. <strong>${ param.users_name }</strong>님 회원 가입을 실패하였습니다.</p>
                    <p>잠시 후 다시 시도해 주세요.</p>
